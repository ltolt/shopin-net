...
public class SshExecuter implements Closeable {
	...
	private SshExecuter(SshInfo info) throws Exception {
		...
		session = jsch.getSession(sshInfo.getUser(), sshInfo.getHost(),
				sshInfo.getPort());
	...
	public static SshExecuter newInstance(String host, Integer port,
...
class SshInfo {
	...
	public SshInfo(String host, Integer port, String user, String key,
			String passPhrase) {
		super();
		this.host = host;
		this.port = port;
