...
public class TestServletContext implements ServletContext {
	 ...
	 */
	public TestServletContext(String warroot) throws Exception {
		this.warroot = warroot;
		System.out.println("------> TestServletContext: WAR root is '" + warroot + "'");

		InputStream is = new FileInputStream(warroot + "/WEB-INF/web.xml");
	...
	public TestServletContext() {
		this.warroot = null;
		System.out.println("------> TestServletContext: no WAR root!!");
	}
...
//		System.out.println("Added context param '" + name);
	...
	public javax.servlet.RequestDispatcher getRequestDispatcher(String path) {
		return new TestRequestDispatcher(path);
	}
	...
	public javax.servlet.RequestDispatcher getNamedDispatcher(java.lang.String A) {
		throw new UnsupportedOperationException("TestServletContext.getNamedDispatcher");
	}
	...
	public void addInitParameter(String name, String s) {
		System.out.println("------> TestServletContext: added init parameter '" + name + "' with value '" + s + "'");
	...
	public void setAttribute(String name, Object attribute) {
		System.out.println("------> TestServletContext: set context attribute '" + name + "' to " + attribute);
