 ...
 * @Path: net.shopin.util.HttpUtil.java
 * @Create By kongm
 * @Create In 2013-7-11 上午11:36:00
 * TODO
 */
...
public class HttpUtil {
	public static String HttpPost(String url, String method, Map parmMap) {
		...
		try {
			...
			if (statusCode != HttpStatus.SC_OK) {
				...
				throw new SystemException(postMethod.getStatusLine().toString());
			}
	...
	// http post方式调用接口
	// public static String toSendMessageByPost(String method,String
	// messageSource,String messageType,String pdSid,String pdSids,String
	// storeNum,String sourceNum,String ip) {
	// InputStream is = null;
	...
	// String
	// date="messageSource="+messageSource+"&uuid="+getUUID()+"&messageType="+messageType+"&pdSid="+pdSid+"&pdSids="+pdSids+"&storeNum="+storeNum+"&sourceNum="+sourceNum+"&ip="+ip;
	//
