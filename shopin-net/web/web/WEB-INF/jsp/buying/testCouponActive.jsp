...
<%@include file="/common/cart_header.jsp" %>
   订单号：<input type="text" id="orderNo" value="" name="orderNo"/>
   订单金额：<input type="text" id="orderSumMoney" value="" name="orderSumMoney"/>
   <a id="useTicketButton" href="javascript:void(0);" class="btn-quan ml5" onclick="commitTicket()">支付</a>
    <script type="text/javascript">
  	function commitTicket(){

  	    var orderNo = $("#orderNo").attr("value");
  	    var orderMoney = $("#orderSumMoney").attr("value");
  	 	var url = "${ctx }/order/testProduceCouponActive.html?orderNo="+orderNo+"&orderMoney=" + orderMoney;
