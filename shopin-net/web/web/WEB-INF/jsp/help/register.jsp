	...
	function validateMobile(){
        ...
        if(mobile==''){
           verifyCodeIsValid=true;
            $('#mobile_div .validate-msg')
                   .html('<span style=\'color:#ff6600;font-size:12px\'></span>');
        ...
        if(!valid){
           verifyCodeIsValid=false;
           $('#mobile_div .validate-msg')
                   .html('<span style=\'color:#ff6600;font-size:12px\'>手机号不正确</span>');
...
%>
<noscript>
<img height="1" width="1" border="0" alt="" style="display: none" src="http://analytics.adsage.cn/atac.gif?acc=936&cid=1061&csid=2626&ver=1.0" />
</noscript>
...
<!--
        function TrackSuccess() {
            ...
            ataTracker.setConversion("1061", "2626");
            ataTracker.track();
        }
//-->
    </script>
...
<body>
<div class="banner-channels"> <img src="${images}/y-login005.gif" title="注册上品用户" /> </div>
<div>
  <%--register开始--%>
  <form action='${ctx}/dqregister.html' method='post' id="register_form">
    ...
    <div id="mylogin-mlog">
      <div class="mylogin-logcontent">
        ...
        <div class="mylogin-logid">
          <div class="mylogin-logadress"  id="mobile_div">输入手机号：&nbsp;
            <input name="iptMobile" type="text" 
                         class="logid-input"  tabindex="1" id="mobile" maxlength="11" onBlur="validateMobile()" />
            <div class="validate-msg"></div>
          </div>
          <div class="logid-tips"  id='confirm_password_info'>
            <div class="login-tip1img"><img src="${images}/y-m003.gif" border="0"/></div>
        ...
        <div class="mylogin-logid1"> <img src="${images}/y-m002.gif" border="0"
                   style="cursor:pointer" onClick="doRegister();"/> </div>
