...
$.ajax({
			...
			success:function(response){
			     ...
			     var isLogin = response.isLogin ? response.isLogin : "没有值";
			     var userName = response.username ?  response.username : "不知道";
			    alert(response + " >>>>" +  isLogin + " +  " +userName );
			 }
...
<a class="signupBtn" href="javascript:void(0);">我要报名登录aaaaa:---->	${member.memEmail}</a><br>
