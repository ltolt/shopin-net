...
<div>
    ...
    <div id=pays-content>
        ...
        <div class="pays-bk0316">
            <li>
               <center>  您的订单${order.orderNo}已经支付成功。     </center>
            </li>
            <li>
              <center> 您已成功参加预购活动，想了解您的预购商品，请点击：<a href="${ctx}/myshopin/preorders.html" target="_blank" style="font-family:Arial;font-size:13px;font-weight:normal;font-style:normal;text-decoration:none;color:#0000FF;">我的预购商品</a>  </center>
            </li>
        </div>
        <br/>
