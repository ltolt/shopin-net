...
<div>
    ...
    <div id=pays-content>
        ...
        <div class="pays-bk0316">
            <li>您的订单${order.orderNo}已支付成功！预计3个工作日内从北京发货，详情请<a href="${ctx}/myshopin/order/${order.orderNo}.html" target="_blank"
...
<script type="text/javascript">
<!-- 
var bd_cpro_rtid="n16srHn";
//-->
</script>
<script type="text/javascript" src="http://cpro.baidu.com/cpro/ui/rt.js"></script>
<noscript>
<div style="display:none;">
<img height="0" width="0" style="border-style:none;" src="http://eclick.baidu.com/rt.jpg?t=noscript&rtid=n16srHn" />
</div>
</noscript>
<!-- 百度回头客  结束 -->
</body>
