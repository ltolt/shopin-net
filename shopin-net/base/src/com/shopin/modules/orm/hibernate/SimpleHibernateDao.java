...
import com.shopin.modules.orm.PropertyFilter;
import com.shopin.modules.orm.PropertyFilter.MatchType;
import com.shopin.modules.utils.ReflectionUtils;
...
public class SimpleHibernateDao<T, PK extends Serializable> extends HibernateDao<T, PK> {
     ...
     * @return 分页查询结果.附带结果列表及所有查询时的参数.
     */
    public Page<T> find(Page page, Criteria c) {
        Assert.notNull(page);
