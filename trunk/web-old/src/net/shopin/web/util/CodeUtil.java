...
public class CodeUtil {
    ...
    private static void initOrderStatus(){
       ...
       orderStatusMap.put("1","等待确认");
       orderStatusMap.put("2","等待付款");
       orderStatusMap.put("3","网银已支付");
       orderStatusMap.put("4","货到付款已确认");
       orderStatusMap.put("5","订单打印,现场配货");
       orderStatusMap.put("6","订单拣选");
        orderStatusMap.put("7","订单发货");
        orderStatusMap.put("8","等待收货");
        orderStatusMap.put("9","完成");
        orderStatusMap.put("10","完成");
        orderStatusMap.put("11","拒签");
...
//       if("2".equals(status)){
//            =stastatustus+(deliveryStatus==null?"0":deliveryStatus);
//       }
       return status;
    }
