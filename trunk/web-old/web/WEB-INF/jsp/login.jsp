...
function cps360Login() {
    $("#cps360_form").get(0).submit();
}
function qqLogin() {
...
<style type="text/css">
		...
		.joint_login a.cps360 { background:url(http://images.shopin.net/images/s_login_360_0810.png) no-repeat 0 0}
...
.mod_cb_jr_pop .pop_flag { position:absolute; width:15px; height:7px; left:30px; top:-6px; background:url(http://imgcache.qq.com/vipstyle/act/caibei_110826_tips/img/bg.png) left -21px no-repeat;}
    ...
    <div id="mylogin-left">
        ...
        <form id="sina_form" method='post' action='${ctx}/sinaLog.html'>
         ...
         <form id="cps360_form" method='post' action='${ctx}/cps360/unionlog.html'>
            <a class="cps360" href="javascript:void(0);" onClick="cps360Login();"><input type="hidden" value="${forward}" name="forward" id="forward"/>360</a>
        </form>
...
<div style="float:right"><a href="http://www.shopin.net/help/huiyuan1.html" title="会员特别专场 金牌惠所" target="_blank"><img src="http://images.shopin.net/images/ad/ad-630160-905.jpg"></a></div>
