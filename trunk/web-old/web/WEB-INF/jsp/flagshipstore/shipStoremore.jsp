        ...
        <div class="col-main">
           ...
           <div class="main-wrap">
            <ul class="content2">
                ...
                <!--工厂店开始-->
                	<li>
					<p class="factory-banner"><span class="fac-biaoti">品牌专柜 网络旗舰店</span></p>
                    <c:forEach items="${flagshipstores}" begin="0" step="1" end="${fn:length(flagshipstores)}" var="store" varStatus="statu">
                        <c:if test="${statu.index%2 ==0}">
							...
							<p class="factory-font">${store.name}</p>
							<p><a href="/shipStore/${store.sid}.html" target="_blank"><img src="${images}${store.logoPic}" alt="${store.name}" title="${store.name}"  border="0" width="367" height="130"></a></p>
						</li>
