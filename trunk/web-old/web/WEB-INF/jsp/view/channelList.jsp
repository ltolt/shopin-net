...
<div id="content">
    <div class="layout grid-s5m0">
        <div class="col-main">
            <div class="main-wrap">
                <div id="content-right">
                    <!--[if !ie]>二级导航开始<![endif]-->
                    <div class="channel-smenu"><a href="${ctx}/${channel.name}/list--.html">${channel.displayName}频道</a>>><c:forEach var="navigation" items="${breadcrumbNavigation.list}" varStatus="status"><a href="${ctx}/${channel.name}/${navigation.url}">${navigation.name}</a><c:if test="${!status.last}">>></c:if></c:forEach></div>                  
                    <!--[if !ie]>二级导航结束<![endif]-->
                    <div class="channel-ad"><a href="http://www.shopin.net/promotion/5810.html" target="_blank"><img src="http://images.shopin.net/images/ad/20120823022.jpg"
                                                                             alt="活动广告"/></a></div>
              </div>
            </div>
            <!--[if !ie]>产品列表开始<![endif]-->
        ...
        <!--[if !ie]>左侧分类开始<![endif]-->
        <div class="col-sub">
            <jsp:include page="/common/channellistleft.jsp"/>
        </div>
        <!--[if !ie]>左侧分类结束<![endif]-->
    </div>
</div>
