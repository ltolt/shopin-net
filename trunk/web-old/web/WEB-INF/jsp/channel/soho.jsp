...
<div id="content">
    <div class="layout grid-s5m0">
        ...
        <div class="col-main">
            ...
            <c:if test="${not empty columns[1].template}">
            <div class="main-wrap">
                 ${columns[1].template}
            </div>
            </c:if>
            <!--[if !ie]>女鞋模块开始<![endif]-->
            <c:if test="${not empty columns[2].template}">
            <div class="main-wrap">
                ${columns[2].template}
            </div>
            </c:if>
            ...
            <!--[if !ie]>内衣模块开始<![endif]-->
            <c:if test="${not empty columns[3].template}">
            <div class="main-wrap">
                ${columns[3].template}
            </div>
            </c:if>
            ...
            <!--[if !ie]>配饰模块开始<![endif]-->
            <c:if test="${not empty columns[4].template}">
            <div class="main-wrap">
                ${columns[4].template}
            </div>
            </c:if>
            ...
            <c:if test="${not empty columns[5].template}">
            <div class="main-wrap">
                ${columns[5].template}
            </div>
            </c:if>
            ...
            <!--[if !ie]>资讯社区开始<![endif]-->
            <c:if test="${not empty columns[6].template}">
            <div class="main-wrap">
                ${columns[6].template}
            </div>
            </c:if>
        ...
        <!--[if !ie]>左侧分类开始<![endif]-->
        <div class="col-sub">
            <jsp:include page="/common/sohochannelleft.jsp"/>
        </div>
        <!--[if !ie]>左侧分类结束<![endif]-->
    </div>
</div>
...
<!-- Google Code for &#20048; Remarketing List -->
<script type="text/javascript">
/* <![CDATA[ */
...
var google_conversion_label = "LyV4CNyc-QEQ2va46gM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1028537178/?label=LyV4CNyc-QEQ2va46gM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
<script type="text/javascript">
<!-- 
var bd_cpro_rtid="n1fzr0";
//-->
</script>
<script type="text/javascript" src="http://cpro.baidu.com/cpro/ui/rt.js"></script>
<noscript>
<div style="display:none;">
<img height="0" width="0" style="border-style:none;" src="http://eclick.baidu.com/rt.jpg?t=noscript&rtid=n1fzr0" />
</div>
</noscript>
</body>
</html>
