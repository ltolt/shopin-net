...
public class JSONRPCView extends AbstractView {
	 ...
	 */
	public static final String DEFAULT_CONTENT_TYPE = "application/jsr";
	...
	protected void renderMergedOutputModel(Map<String, Object> model,
        ...
        sb.append(model.get("function")).append("(").append(objectMapper.writeValueAsString(value)).append(")");
        FileCopyUtils.copy(sb.toString(),response.getWriter());
	}
