...
<script type="text/javascript">
    ...
    function dosearch() {
       ...
       if($("#search-key").val()=="shopin070519"){
           
                 window.location.href = '${ctx}/help/huiyuan.html';
...
<style type="text/css">
	...
	.h_mo {width:300px;padding:46px 0 0 130px;float:left;}
	.sub_logo { position:absolute; top:28px; left:69px}
	.sub_logo a ,.logo a{ outline:none}
...
<div id="header">
    <div class="header0829">
        ...
        <!--div class="sub_logo"><a href="http://www.shopin.net" target="_blank"><img src="" alt="上品折扣网-www.shopin.net" /></a></div-->
        <div class="h_mo">
    ...
    <div class="st_nav">
        ...
        <img class="nav_new" src="http://images.shopin.net/images/st_10.gif" />
    </div>
    </div>
    <div class="subnav">
        <ul>
