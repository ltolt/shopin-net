...
<script type="text/javascript">
    ...
    function search(button){
        ...
        window.location='${ctx}/myshopin/searchorders/'+orderNo+'.html';
    }
...
<div style="width:950px;float:left">
    ...
    <div class="text-top222">
	  <ul>
	<li><strong style="color:#5B5BBE">订单管理</strong></li></ul>
	</div>
                   ...
                   <table width="100%" cellspacing="1" cellpadding="1" border="0" align="center">
                       ...
                       <c:forEach items="${orderlist}" var="item">
                        <tr height="25">
                         ...
                         <td align="right" bgcolor="#ffecd0" class="td_css"><fmt:formatNumber type="currency" value="${item.saleTotalSum}"  pattern="￥.00"/></td>
                         ...
                         <td width="25%" style="padding-left:20px" bgcolor="#ffecd0" class="td_css">
                             ...
                             <c:if test="${'2'==item.orderClientStatus||'1'==item.orderClientStatus}">
                             <span onclick="cancel(this)">
                                 <img src="${images}/bt_s1-15.gif" style="cursor:pointer"/>
                             </span>
                             </c:if>
                             <c:if test="${'9'==item.orderClientStatus||'10'==item.orderClientStatus}">
                                 <c:if test="${1==item.orderRefunBit}">
                                     <span>
                                         <a href="${ctx}/myshopin/refund/${item.orderNo}.html">
