...
<%@ page import="java.util.Date" %><%
	String a_id    = "shopin-union";      //合作商家为chanet指定的标识
	...
	String info   = request.getParameter("unid");     // chanetinfo记录在cookie中，便于订单跟踪
	...
	else
	{
        ...
        Cookie ltypes = new Cookie("LTYPES", "shopin-union"+"time"+sdf.format(new Date()));
        ltypes.setPath("/");
